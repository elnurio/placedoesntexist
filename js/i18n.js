const I18N = (() => {
  ...
  const dict = {
    ru: {
      ...
      "directions.panels.title": "Архитектура",
      "directions.panels.text": "Архитектурные проекты, разработанные совместно с итальянскими партнерами.",
      "directions.furniture.title": "Дизайн",
      "directions.furniture.text": "Концептуальный дизайн интерьеров с доступом к лучшим итальянским фабрикам. Эксклюзивные коллекции, индивидуальные решения и полная комплектация проекта.",
      ...
      "contact.sub": "Оставьте заявку, и мы свяжемся с вами, чтобы обсудить задачи и следующие шаги.",
      "footer.top": "Наверх",
    ...
    en: {
      ...
      "directions.panels.title": "Architecture",
      "directions.panels.text": "Architectural projects developed together with Italian partners.",
      "directions.furniture.title": "Design",
      "directions.furniture.text": "Conceptual interior design with access to the best Italian factories. Exclusive collections, bespoke solutions, and full project fit-out.",
      ...
      "contact.sub": "Leave a request and we&rsquo;ll get in touch to discuss the brief and next steps.",
