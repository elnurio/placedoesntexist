const I18N = (() => {
  ...
  const dict = {
    ru: {
      ...
      "directions.furniture.text": "Комплексное оснащение офисов, общественных пространств и жилых интерьеров: от отдельных предметов до серийных решений.",
    ...
    en: {
      ...
      "directions.furniture.text": "Complete furnishing for offices, public spaces, and residential interiors — from individual pieces to production-line solutions.",
